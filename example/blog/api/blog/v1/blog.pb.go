...
type BatDeleteReq struct {
	...
	Ids []string `protobuf:"bytes,1,rep,name=Ids,proto3" json:"Ids,omitempty" v:"required"` // v: required
}
...
func (x *BatDeleteReq) GetIds() []string {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_blog_v1_blog_proto_rawDesc = []byte{
	...
	0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x3a, 0x5a, 0x38,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x79, 0x69, 0x71, 0x69, 0x61,
	0x6e, 0x67, 0x33, 0x33, 0x34, 0x34, 0x2f, 0x67, 0x66, 0x2d, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2f,
	0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x61, 0x70, 0x69,
	0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
